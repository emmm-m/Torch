...
import com.bucai.torch.util.ScreenUnit;
import com.bumptech.glide.Glide;
import com.bucai.torch.util.AudioTrackManager;
import com.bucai.torch.view.PhotoActivity;
...
public class ChatRecyclerAdapter extends RecyclerView.Adapter<ChatRecyclerAdapter.MyViewHolder> {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        if (viewType == TEXT_LEFT) {
            ...
            View view = LayoutInflater.from(context).inflate(R.layout.item_pic_left, parent, false);
    ...
    public void onViewRecycled(MyViewHolder holder) {
        switch (holder.viewType) {
            case PIC_LEFT:
                holder.pic_left.setImageResource(R.drawable.ic_error);
                holder.pic_icon_left.setImageResource(R.drawable.ic_header_default);
                break;
            case PIC_RIGHT:
                holder.pic_right.setImageResource(R.drawable.ic_error);
                holder.pic_icon_right.setImageResource(R.drawable.ic_header_default);
                break;
        }
